"""
A simple 3-layer neural network to learn the XOR function. The network has 2 input neurons, 2 hidden neurons, and 1 output neuron. The hidden neurons use the tanh activation function, and the output neuron uses the logistic function. The network is trained using backpropagation and gradient descent until it converges to the correct output for all training examples.
"""
